...
weatherConditions.open('GET',
 'https://api.openweathermap.org/data/2.5/weather?zip=11207,us&appid=20f3aa56b44ef5931859d9562db00713&units=imperial', true);
...
// GET THE FORECARST
weatherForecast.open('GET', 'https://api.openweathermap.org/data/2.5/forecast?zip=11207,us&appid=20f3aa56b44ef5931859d9562db00713&units=imperial', true);
...
if (weatherForecast.status === 200){
    ...
    var icon_path = "http://openweathermap.org/img/w/"
    +iconcode+".png";
